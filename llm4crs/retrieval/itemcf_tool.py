...
class SimilarItemTool:
    def __init__(self, name: str, desc: str, item_sim_path: str, item_corpus: BaseGallery, buffer: CandidateBuffer, top_ratio: float=0.05, **kwargs) -> None:
    ...
    def run(self, inputs):
        ...
        if len(candidates) > 0:
            ...
            # candidates = list(range(1, self.item_corpus.corups.shape[0]+1))
